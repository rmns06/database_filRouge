...
values
    ...
    (
        'Formations Métiers de la formation ',
...
- 12 ‘Plans d’action’ présentent l'intérêt du plan d'action, les actions à mener, des éclairages d'expert, des apports novateurs,au moins un cas d'entreprise et les critères de réussite du plan d'action.",
    ...
    (
        'Guide des métiers de la formation ',
        "Cet ouvrage rassemble des informations utiles à tous les formateurs ou personnes souhaitant le devenir : données statistiques, économiques et juridiques, adresses utiles, description des activités et fonctions, répertoire des diplômes préparant aux métiers de la formation de la formation, recensement des organisations professionnelles, informations sur les missions et le fonctionnement des institutions européennes dédiées à la formation...",
       70.9,25
...
Cette 6eédition s'enrichit de mises à jour sur les évolutions des protocoles de sécurité et sur les nouveaux modes de cyberattaques. Elle comporte en outre de nouveaux exercices.",
    ...
    (
        'La transformation digitale des entreprises - Principes, exemples, mise en oeuvre et impact social',
        "La transformation digitale : un sujet essentiel pour les entreprises... ce qui faut faire et pourquoi.
...
– Enfin il fournit des pistes de réflexion sur la gestion en temps de crise.",
    ...
    (
        ...
        "Les livres comme les articles professionnels ou académiques traitant de la transformation numérique sont légion ces dernières années.
    ...
    (
        ...
        (
            ...
            from
                article
            where
                titre = 'Animer un groupe leadership, communication et résolution de conflits'
        ),
        'métiers de la formation'  );
    insert into
    livre
    ...
    (
        ...
        (
            ...
            from
                article
            where
                titre = 'Les nouveaux métiers de la formation de la formation : Développer de nouvelles compétences pour une formation réinventée'
        ),
        'métiers de la formation'
    );
    insert into
    ...
    (
        ...
        (
            ...
            from
                article
            where
                titre = "S'engager pour accompagner: Valeurs des métiers de la formation de la formation"
        ),
        'métiers de la formation'
    );
    insert into
    ...
    (
        ...
        (
            ...
            from
                article
            where
                titre = "Formations Métiers de la formation de la formation"
        ),
        'métiers de la formation'
    );
    insert into
    ...
    (
        ...
        (
            ...
            from
                article
            where
                titre = "Guide des métiers de la formation de la formation"
        ),
        'métiers de la formation'
    );
    ...
    (
        ...
        (
            ...
            from
                article
            where
                titre = 'La Cybersécurité pour les Nuls'
        ),
        'Cybersécurité'
    );
    insert into
    ...
    (
        ...
        (
            ...
            from
                article
            where
                titre = 'Cybersécurité et cyberdéfense : enjeux stratégiques'
        ),
        'Cybersécurité'
    );
    insert into
    ...
    (
        ...
        (
            ...
            from
                article
            where
                titre = 'Dictionnaire de la cybersécurité et des réseaux '
        ),
        'Cybersécurité'
    );
    insert into
    ...
    (
        ...
        (
            ...
            from
                article
            where
                titre = 'Cybersécurité - 6e éd. - Analyser les risques, mettre en oeuvre les solutions '
        ),
        'Cybersécurité'
    );
    insert into
    ...
    (
        ...
        (
            ...
            from
                article
            where
                titre = 'La transformation digitale des entreprises - Principes, exemples, mise en oeuvre et impact social'
        ),
    ...
    (
        ...
        (
            ...
            from
                article
            where
                titre = 'Le guide de la transformation digitale: La méthode en 6 chantiers pour réussir votre transformation !'
        ),
        'Transformation digitale'
    );
    insert into
    ...
    (
        ...
        (
            ...
            from
                article
            where
                titre = 'Pilotage du SI et de la transformation digitale - 4e éd. '
        ),
        'Transformation digitale'
    );
    insert into
    ...
    (
        ...
        (
            ...
            from
                article
            where
                titre = 'La transformation digitale en entreprise '
        ),
        'Transformation digitale'
    );
    insert into
    ...
    (
        ...
        (
            ...
            from
                article
            where
                titre = "Transformation digitale : l'avènement des plateformes"
        ),
        'transformation digitale'
    );
    insert into
