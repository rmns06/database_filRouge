...
"Maîtrisez rapidement ce lecteur PDF aux nombreuses fonctionnalités",
10,
0),
('Paint Initiation',
"Maîtrisez rapidement les fonctions essentielles de Paint",
10,
0);

-- articles multimedia
insert into article (titre, resume, prix, stock) values ('Photoshop Initiation', 
"Maîtrisez rapidement Photoshop pour éditer vos images", 
10,
3),
('Windows Movie Maker Initiation',
"Maîtrisez rapidement Windows Movie Maker pour faire vos montages vidéos",
10,
5),
('Audacity Initiation',
...
"Créez vos instrumentaux avec FL Studio",
10,
7),
('MPV Initiation',
